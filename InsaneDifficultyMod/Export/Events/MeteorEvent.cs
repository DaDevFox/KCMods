...
//{
//    public class MeteorEvent : IDModEvent
//    {
...
//            int landmass = (int)SRand.Range(0, World.instance.NumLandMasses);
//            Cell origin = World.instance.cellsToLandmass[landmass].RandomElement();
...
//            if (startX < 0 || endX > World.instance.GridWidth ||
//                startZ < 0 || endZ > World.instance.GridHeight)
//            {
...
//            // Core impact
//            World.instance.ForEachTileInRadius(origin.x, origin.z, radius, (int x, int z, Cell cell) => 
//            {
//                if (cell != null)
//                {
...
//                    if (c_fire && fires)
//                        Assets.Code.FireManager.instance.StartFireAt(cell);

//                    if (c_treeKill)
//                        TreeSystem.instance.FellAllTrees(cell);
