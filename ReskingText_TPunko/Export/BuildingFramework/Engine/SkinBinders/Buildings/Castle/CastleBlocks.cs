...
#else
                (World.GetLandmassOwner(building.LandMass()) != null && World.GetLandmassOwner(building.LandMass()).BuildingMaterial != null) ? World.GetLandmassOwner(building.LandMass()).BuildingMaterial : World.GetLandmassOwner(0).BuildingMaterial;
#endif
